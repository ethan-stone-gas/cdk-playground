            ...
            try {
              ...
              const outputEventHandlers = [
                ...
                },
                {
                  ...
                  handler: (data: OutputEvents.OutputContentEndEvent) => {
